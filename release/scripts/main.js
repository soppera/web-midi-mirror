...
navigator.requestMIDIAccess()
    ...
    // changes.
    log_midi_events_input.addEventListener("change", e => localStorage.setItem(log_midi_events_key, log_midi_events_input.checked.toString()));
